...
-(void)didAddTask:(Task *)task
{
    ...
    if (!taskObjectAsPropertyLists) taskObjectAsPropertyLists = [[NSMutableArray alloc] init];
    
    [taskObjectAsPropertyLists addObject:[self taskObjectAsAPropertyList:task]];
